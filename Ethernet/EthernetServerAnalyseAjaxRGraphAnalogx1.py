...
<html>
    <head>
	   ...
	   // code javascript par X. HINAULT - www.mon-club-elec.fr - tous droits reserves - 2013 - GPL v3
        ...
        window.onload = function () { // au chargement de la page
			...
			gauge = new RGraph.Gauge('nomCanvasRGraph', 0, 4095, val);
	...
	<br/>
	Serveur Pyduino : Test RGraph avec mesure analogique obtenue par reponse requete Ajax 
	<br/>
...
def reponseAJAXServeur():
	...
	value=analogRead(A2) # mesure analogique sur la broche A2
