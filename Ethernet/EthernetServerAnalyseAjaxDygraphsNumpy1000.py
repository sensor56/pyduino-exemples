...
def loop():
	...
	if requete.startswith("GET /ajax"): # si la requete recue est une requete ajax
		...
		#print "Reponse envoyee au client distant : "  debug
...
<html>
    <head>
	   ...
	   // code javascript par X. HINAULT - www.mon-club-elec.fr - tous droits reserves - 2013 - GPL v3
        ...
        var delai=10; // delai en ms entre 2 requetes AJAX
		var val=0;
...
"""
   ...
   <div id="graphdiv"></div>
	...
	<br/>
	Serveur Pyduino : Mise a jour graphique Dygraphs 1000 valeurs aleatoires  par requete Ajax 
	<br/>
...
def reponseAJAXServeur():
	...
	#--- ici on genere un nouveau tableau aleatoire de 1000 valeurs 
