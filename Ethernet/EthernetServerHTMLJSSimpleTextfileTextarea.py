...
# Serveur TCP générant une page HTML avec code Javascript simple : ouvrir fichier dans textarea.
...
<html> 
	...
	<head>    
		...
		var mytextarea=null; // objet global 
			...
			window.onload = function () { // au chargement de la page	 
				...
				mytextarea=document.getElementById("text"); // creation objet JS representant textarea HTML
				mytextarea.value="""
				+
				dataText
				+
	...
	Mes donn&eacute;es dans une zone de texte par code Javascript : 
	<br />   
