...
#""")
	...
	data=np.zeros((1000,2)) # tableau de 1000 lignes x 2 colonnes
	data[:,0] = np.arange(0,1000,1) # remplissage 1ere colonne = les x

	#data[:,1] = np.arange(0,1000,1) # remplissage 2eme colonne = les y
	data[:,1] = np.random.normal(0,1,size=1000)  # remplissage 2eme colonne = les y1 
...
"""
    ...
    <div id="graphdiv"></div>
    <br />
    Test de graphique Dygraphs : affichage 1000 valeurs de donn&eacute;es (tableau numpy)
